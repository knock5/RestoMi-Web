...
const createRestoItemTemplate = (resto) => `
  <div class="card">
    ...
    <img data-src="${CONFIG.BASE_IMAGE_URL_SMALL + resto.pictureId}" alt="image ${resto.name} restaurant" class="card-image lazyload">
...
const createRestoDetailTemplate = (resto) => `  
  <div class="d-content">
    <div class="d-img">
      <img class="dt-img lazyload" data-src="${CONFIG.BASE_IMAGE_URL_MEDIUM + resto.pictureId}" alt="${resto.name} image">
    </div>
